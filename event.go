...
type EventGetParams struct {
	...
	// search results.
	SelectAlerts SelectQuery `json:"selectAlerts,omitempty"`
	...
	SelectAcknowledgements SelectQuery `json:"selectAcknowledges,omitempty"`

	// SelectAcknowledgements return a tags property with event tags.
